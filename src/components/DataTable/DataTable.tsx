...
const DataTable = <T extends { id?: string | number }>({
    ...
    return (
      <div className="w-full overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="min-w-full">
          ...
          {/* Rows skeleton */}
          {[1, 2, 3].map((row) => (
            <div key={row} className="px-6 py-4 grid grid-cols-12 gap-4 border-b border-gray-100 dark:border-gray-700">
              {selectable && (
                <div className="col-span-1">
                  <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"></div>
                </div>
    ...
    return (
      <div className="w-full flex flex-col items-center justify-center py-12 px-4 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        <div className="text-center">
          ...
          <h3 className="text-sm font-medium text-gray-900 dark:text-gray-300 mb-1">No data available</h3>
  ...
  return (
    <div className={clsx(
      'w-full overflow-x-auto table-scroll max-h-[calc(100vh-200px)]', // Added max-height
      className
    )}>
